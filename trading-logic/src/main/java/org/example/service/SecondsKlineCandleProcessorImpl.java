...
public class SecondsKlineCandleProcessorImpl implements KlineCandleProcessor {
    ...
    public SecondsKlineCandleProcessorImpl() {
    ...
    boolean isLastSecondOfHour(LocalDateTime dateTime) {
        return dateTime.getMinute() == 59 && dateTime.getSecond() == 59;
    }
